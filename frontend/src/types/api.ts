...
export interface ChatResponse { turn: ConversationTurn; decision: { emotion_state: EmotionState; strategy: string }; roleplay: RolePlayState | null; feedback: Feedback | null }
