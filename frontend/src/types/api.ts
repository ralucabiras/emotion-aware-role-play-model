...
export interface Feedback { scenario_id: string; observed: string[]; strengths: string[]; suggestions: string[]; generation_source: string; metrics: { name: string; score: number; evidence_turns?: number[] }[] }
