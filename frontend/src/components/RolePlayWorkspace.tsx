...
export function ScenarioSetup({scenarios, selected, difficulty, busy, onScenario, onDifficulty, onStart, onScenarios}: {scenarios: Scenario[]; selected: string; difficulty: string; busy: boolean; onScenario: (id: string) => void; onDifficulty: (level: string) => void; onStart: (ratings: {confidence:number;anxiety:number}) => void; onScenarios:(items:Scenario[])=>void}) {
...
export function FeedbackScreen({scenario, feedback, state, onRetry, onRewind, onConversation}: {scenario?: Scenario; feedback: Feedback; state: RolePlayState | null; onRetry: () => void; onRewind:()=>void; onConversation: () => void}) {
